        ...
        try:
            ...
            if data.expected_hashrate != None:
                if float(data.expected_hashrate) > 0:
                    miner['perf'] = round(float(data.hashrate)/float(data.expected_hashrate),2)*100
...
grid = ui.aggrid({
    ...
    'columnDefs': [
        ...
        {'headerName': 'IP', 'field': 'ip', 'filter': 'agTextColumnFilter', 'floatingFilter': True},
        {'headerName': 'Location', 'field': 'location', 'filter': 'agTextColumnFilter', 'floatingFilter': True},
        {'headerName': 'Model', 'field': 'model', 'filter': 'agTextColumnFilter', 'floatingFilter': True},
        {'headerName': 'FW', 'field': 'fw', 'filter': 'agTextColumnFilter', 'floatingFilter': True},
        {'headerName': 'Temp', 'field': 'temp'},
        {'headerName': 'Hashrate', 'field': 'hashrate'},
        {'headerName': 'Performance', 'field': 'perf', 'cellClassRules': {
        ...
        {'headerName': 'Worker', 'field': 'worker', 'filter': 'agTextColumnFilter', 'floatingFilter': True},
    ...
    ':pagination': True,
}, html_columns=[1],theme="balham-dark").style('height: 800px')
...
with ui.row().style('align-items: center;'):
    rangestable = ui.table(rows=ranges_to_scan_g, selection="single", row_key="nickname")
